...
<div class="col-md-12 col-lg-12">
	<div class="card">
		<div class="card-header">
			<div class="card-title">Tambah User</div><hr>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <select class="form-control" name="hak_akses" required>
                    ...
                    <option value="BPMPH">BPMPH</option>
                  </select>
                </div>
              </div>
            </div><!-- /.box body -->
...
elseif ($_GET['form']=='edit') { 
      ...
      $query = mysqli_query($mysqli, "SELECT * FROM tb_users WHERE id_user='$_GET[id]'") 
...
<div class="col-md-12 col-lg-12">
	<div class="card">
		<div class="card-header">
			<div class="card-title">Edit User</div><hr>
